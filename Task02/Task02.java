...
public class Task02 {
    public static void main(String[] args) {
        ...
        //task4
        int number = 1234;
        System.out.println("\n" + number + " makes increase sequence -> " + FourDigitNumber.isIncSequnce(number));
        System.out.println(number + " makes decrease sequence -> " + FourDigitNumber.isDecSequnce(number));
