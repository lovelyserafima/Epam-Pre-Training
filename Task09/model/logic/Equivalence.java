...
public class Equivalence {
    ...
    //exception method (check whether number1 and number2 >= 0)
    private static void checkNegative(int number1, int number2) throws NegativeNumberException {
        if (number1 < 0){
